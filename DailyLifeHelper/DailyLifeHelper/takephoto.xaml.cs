...
namespace DailyLifeHelper
{
    ...
    public partial class takephoto : ContentPage
    {
        ...
        private async void UploadtoS3_Clicked(object sender, EventArgs e)
        {
            ...
            //call sendtos3 function using stream and it's working.

            await sendMyFileToS3Stream(file.GetStream(), "awss3dailylifehelperapp", "images", filename, "yourkey", "yoursecuritycode");
        ...
        async Task sendMyFileToS3Stream(System.IO.Stream localFilePath, string bucketName, string subDirectoryInBucket, string fileNameInS3, string youraccesskey, string yoursecuritykey)
        {
            // input explained :
            // localFilePath = we will use a file stream , instead of path
            // bucketName : the name of the bucket in S3 ,the bucket should be already created
